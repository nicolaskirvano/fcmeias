...
title: "Meio-campistas baratos no EA FC em 03/07 — PS"
draft: false
featured: false
tags:
  - baratos
  ...
  - budget
  - ps
description: "Em 03/07/2026 no PS, Andrés Cubas liderou a seleção de Meio-campistas por 12.000 coins. Compare 15 cartas, OVR, preço, 7d e gráfico."
---
...
O preço mediano do recorte foi **13.000 coins** e 12 cartas vinham de queda em 7d. 2 opções estavam exatamente no teto de 15.000 coins. OVR é só um filtro inicial; função, atributos, PlayStyles e química precisam ser conferidos antes de montar o time.

![Gráfico de preço em coins para os destaques de Meio-campistas baratos no EA FC em 03/07 — PS](/charts/jogadores-baratos-ea-fc-2026-07-03-ps.svg)
...
- **Pedri (89, CM)** da LALIGA EA SPORTS, a apenas **2k coins** — vem **caindo na semana**, era uma opção relativamente barata naquele recorte.
